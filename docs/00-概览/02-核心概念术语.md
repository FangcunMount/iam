...
| `Authorization Snapshot` | 读取主体在某域和应用下的角色、权限与版本。 | [../../internal/apiserver/application/authz/authorization](../../internal/apiserver/application/authz/authorization)、[../../api/grpc/iam/authz/v1/authz.proto](../../api/grpc/iam/authz/v1/authz.proto) | Snapshot 适合接入方缓存或显示，不是策略写入口。 |
