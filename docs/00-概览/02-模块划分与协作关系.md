...
| 如何快速搜索可见 Profile | Suggest | ProfileSearchTerm、ProfileAccessScope、Snapshot |
...
| Suggest | ProfileSearchTerm、ProfileAccessScope、Snapshot、ProfileSuggestItem | Identity.Profile；AuthZ 可见范围 | Profile 写模型、登录认证、通用授权策略管理 |
