...
```mermaid
flowchart TD
    Catalog["application/cachegovernance/catalog.go"]
...
- 静态目录：[../../internal/apiserver/application/cachegovernance/catalog.go](../../internal/apiserver/application/cachegovernance/catalog.go)。
