...
- AuthZ 对敏感操作读取当前原生 runtime snapshot；
...
当前拆分 User/Profile/ProfileLink、LoginIdentity/Credential、Assignment/RoleInheritance/PermissionGrant，使每类事实按自己的生命周期演化。代价是需要明确跨模块用例和映射，不能再靠一条 SQL 得到所有结论。
