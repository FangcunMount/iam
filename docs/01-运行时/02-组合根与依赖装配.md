...
> 状态：设计目标 · 第一版正文，待继续按源码、配置、container 结构和架构测试核对细节。
...
| Suggest | `../../internal/apiserver/container/suggest` | ProfileSearchTerm、ProfileAccessScope、ProfileSuggestionIndex、索引 runtime |
