...
本文是 Identity 的代码导航文档，不重复完整领域模型与关键链路。
...
flowchart TD
    ...
    Grpc["transport/grpc/service/identity\ngRPC service / proto mapper"]
...
| gRPC transport | `../../../internal/apiserver/transport/grpc/service/identity` | gRPC service、proto mapper |
...
| gRPC | `../../../internal/apiserver/transport/grpc/service/identity` | Identity gRPC service、proto mapper |
...
5. transport/grpc/service/identity proto mapper
