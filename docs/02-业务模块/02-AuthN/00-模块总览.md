...
![IAM 三核心模块领域模型 V7](../../_images/architecture/core-domain-model-v7.png)

[SVG 图源](../../_images/architecture/core-domain-model-v7.svg)
...
flowchart LR
    ...
    Principal --> Grant["AuthenticationGrant"]
...
- AccessToken/RefreshToken：用户访问声明与续期能力；
...
| IssueAuthentication / GrantIssuer | Admission 后创建 Session，再 mint/save refresh | mint 或 save refresh 失败可能留下孤儿 Session |
