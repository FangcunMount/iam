...
| Token application/runtime | `../../../internal/apiserver/application/authn/token` | Token 签发、验证、刷新、JWKS 相关逻辑 |
| Token infra | `../../../internal/apiserver/infra/token` | Token signer/verifier/JWKS provider |
| MySQL LoginIdentity | `../../../internal/apiserver/infra/mysql/loginidentity` | LoginIdentity repository 实现 |
| MySQL Credential | `../../../internal/apiserver/infra/mysql/credential` | Credential repository 实现 |
| MySQL JWKS | `../../../internal/apiserver/infra/mysql/jwks` | key/JWKS 持久化实现 |
| Session / Challenge store | `../../../internal/apiserver/infra` | Redis/MySQL/内存等 store 实现 |
...
| AuthN value objects | `../../../internal/apiserver/domain/authn` | AuthMethod、AMR、Status、TokenID、SessionID 等 |
...
| Token application | `../../../internal/apiserver/application/authn/token` | Token/JWKS/JWK 相关用例 |
...
| Verify / Middleware support | `../../../internal/apiserver/application/authn`、`token` | Bearer token 验证和 Principal 恢复 |
...
| 协作 | 建议 port 语义 |
| --- | --- |
| 查询或创建 User | `IdentityUserResolver` / `UserCreator` / `UserStatusChecker` |
...
| 能力 | 路径 | 说明 |
| --- | --- | --- |
| LoginIdentity repository | `../../../internal/apiserver/infra/mysql/loginidentity` | LoginIdentity 持久化与查询 |
| Credential repository | `../../../internal/apiserver/infra/mysql/credential` | Credential 持久化与查询 |
| JWKS repository | `../../../internal/apiserver/infra/mysql/jwks` | Key/JWKS 持久化 |
| Token infra | `../../../internal/apiserver/infra/token` | signer/verifier/JWKS provider |
| Session store | `../../../internal/apiserver/infra` | Redis/MySQL/内存实现 |
| Challenge store | `../../../internal/apiserver/infra` | OTP/OAuth state/nonce 存储 |
| Password hasher | `../../../internal/apiserver/infra` | 密码 hash/verify adapter |
...
| REST middleware | `../../../internal/apiserver/transport/rest` | Bearer token 验证与 Principal 注入 |
| gRPC AuthN | `../../../internal/apiserver/transport/grpc/service/authn` | AuthN gRPC service、proto mapper |
| gRPC interceptor | `../../../internal/apiserver/transport/grpc` | gRPC metadata token 验证与 Principal 注入 |
| JWKS endpoint | `../../../internal/apiserver/transport/rest/authn` | JWKS REST endpoint |
