...
> 状态：待补证据 · 第一版正文，待继续按源码目录、契约文件、组合根、配置和架构测试逐项核对。
...
| gRPC transport | `../../../internal/apiserver/transport/grpc/authn` | AuthN gRPC service、interceptor、proto mapper |
...
| gRPC AuthN | `../../../internal/apiserver/transport/grpc/authn` | AuthN gRPC service、proto mapper |
