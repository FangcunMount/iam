...
> 状态：设计目标
> 第一版正文，待继续按 `application/idp`、`domain/idp`、WechatApp repository、Credentials store、SecretVault、provider callback、REST/gRPC 契约和测试逐项核对。
