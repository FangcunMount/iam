...
> 状态：待补证据 · 第一版正文，待继续按源码目录、契约文件、组合根、微信/企微 provider adapter、AppToken cache、Credentials store、配置和架构测试逐项核对。
...
本文是 IDP 的代码导航文档，不重复完整领域模型和关键链路。领域模型见 [01-领域模型-WechatApp-Credentials-AppToken-ExternalIdentity.md](01-领域模型-WechatApp-Credentials-AppToken-ExternalIdentity.md)，模块边界见 [05-模块边界-IDP与AuthN.md](05-模块边界-IDP与AuthN.md)。
...
| Application WechatApp | `../../../internal/apiserver/application/idp/wechatapp` | 微信应用配置、查询、管理用例，具体以代码为准 |
| Application Prepare | `../../../internal/apiserver/application/idp/prepare` | 外部身份解析前置准备或 provider proof 准备，具体以代码为准 |
...
| WeChat infra | `../../../internal/apiserver/infra/wechatapi` | 微信/企微 API adapter，具体以代码为准 |
...
| gRPC transport | `../../../internal/apiserver/transport/grpc/idp` | IDP gRPC service、proto mapper，若已实现 |
...
| AppToken / AppAccessToken | `../../../internal/apiserver/domain/idp/wechatapp`、`../../../internal/apiserver/domain/idp` | provider access token，具体以代码为准 |
| ExternalIdentity | `../../../internal/apiserver/domain/idp` | 外部身份声明，具体以代码为准 |
| Provider / AppType / Status | `../../../internal/apiserver/domain/idp/wechatapp` | provider 类型、应用类型和状态枚举，具体以代码为准 |
| Domain errors | `../../../internal/apiserver/domain/idp` | IDP 领域错误，具体以代码为准 |
...
| Prepare application | `../../../internal/apiserver/application/idp/prepare` | 外部身份解析准备、provider proof 相关准备，具体以代码为准 |
| IDP application root | `../../../internal/apiserver/application/idp` | IDP application 根目录 |
| ExternalIdentity resolver | `../../../internal/apiserver/application/idp` | 外部身份解析 use case，具体以代码为准 |
| AppToken service | `../../../internal/apiserver/application/idp` | provider access token 获取与缓存，具体以代码为准 |
| Credential rotation | `../../../internal/apiserver/application/idp/wechatapp` | 密钥轮换用例，具体以代码为准 |
...
| Provider callback verifier | `../../../internal/apiserver/infra/wechatapi`、`../../../internal/apiserver/infra` | callback 验签/解密，具体以代码为准 |
...
| gRPC IDP | `../../../internal/apiserver/transport/grpc/idp` | IDP gRPC service、proto mapper，若已实现 |
...
| AuthN wiring with IDP | `../../../internal/apiserver/container/authn`、`../../../internal/apiserver/container/idp` | AuthN provider login strategy 与 IDP resolver 装配，具体以代码为准 |
