...
> 状态：待补证据 · 第一版正文，待继续按 `internal/pkg/architecture`、`internal/apiserver/domain`、`application`、`infra`、`transport`、`container`、`pkg/sdk` 和实际 import 图逐项核对。
...
transport/rest/suggest handler
  ...
  -> domain/suggest Query / ProfileAccessScope / SuggestResult
