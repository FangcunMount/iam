...
- container 如何初始化模块；
- REST/gRPC 如何注册；
- SessionTokenIssuer / SessionTokenPairIssuer 如何签发登录态 token；
...
| `04-身份Identity` | `domain/identity/user`、`domain/identity/profile`、`domain/identity/profilelink`、`application/identity`、`transport/rest/identity`、`api/rest/identity`、`api/grpc/identity` |
