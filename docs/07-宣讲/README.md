...
> `07-宣讲/` 是表达层：把 `docs/00`～`docs/06` 的系统事实、设计边界和证据链，组织成可对外讲、可面试答、可技术分享的材料。
...
| `05-Identity与ProfileLink讲法.md` | 讲 User、Profile、ProfileLink 建模与身份关系边界 |
...
| `09-REST-gRPC-SDK接入讲法.md` | 讲 REST、gRPC、SDK 三层接入投影 |
| `10-工程质量与架构护栏讲法.md` | 讲 architecture tests、contract tests、SDK compile test、docs-hygiene |
| `11-30分钟技术分享脚本.md` | 整合型 30 分钟分享讲稿 |
| `12-架构图素材索引.md` | 可复用 Mermaid 图素材索引 |
| `13-面试追问证据索引.md` | 问题 -> 回答 -> 证据 -> 展开 的面试作战地图 |
...
> `07-宣讲/` 把 IAM 的系统事实、设计边界和证据链组织成可对外表达、可面试追问、可技术分享的材料。