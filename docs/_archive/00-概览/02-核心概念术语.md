...
| ---- | ---- | ---- | ---- | ---- |
| Account | 可登录账号。 | `domain/authn/legacyaccount`、`application/authn/account` | REST account，gRPC `AccountOnboardingService` | Account 不等于 User；一个 User 可关联不同登录账号。 |
...
| User | IAM 用户主体。 | `domain/identity/user`、`application/identity/user` | REST/gRPC `User` | User 不是登录凭据。 |
| Profile | 儿童或个人档案。 | `domain/identity/profile`、`application/identity/profile` | REST/gRPC `Profile` | Profile 不是账号。 |
| ProfileLink | User 与 Profile 的档案关系。 | `domain/identity/profilelink`、`application/identity/profilelink` | REST/gRPC `ProfileLink` | 可表达监护关系语义，但不等同法律监护裁定。 |
...
| 术语 | 业务含义 | 代码证据 | 边界说明 |
| ---- | ---- | ---- | ---- |
| `User` | IAM 内部用户主体。 | [../../internal/apiserver/domain/identity/user](../../internal/apiserver/domain/identity/user)、[../../internal/apiserver/application/identity/user](../../internal/apiserver/application/identity/user) | User 不等于 Account；User 可被账号、外部身份和 profile link 使用。 |
| `Profile` | 儿童或个人档案。 | [../../internal/apiserver/domain/identity/profile](../../internal/apiserver/domain/identity/profile)、[../../internal/apiserver/application/identity/profile](../../internal/apiserver/application/identity/profile) | Profile 是档案，不是登录主体。 |
| `ProfileLink` | User 与 Profile 的关系。 | [../../internal/apiserver/domain/identity/profilelink](../../internal/apiserver/domain/identity/profilelink)、[../../internal/apiserver/application/identity/profilelink](../../internal/apiserver/application/identity/profilelink) | 中文可解释为档案关系或监护关系语义，但代码和合同名以 ProfileLink 为准。 |
| `Linker` | 建立和撤销档案关系的领域能力。 | [../../internal/apiserver/domain/identity/profilelink](../../internal/apiserver/domain/identity/profilelink) | 负责领域校验和实体变化，持久化由 application/UoW 承担。 |
| `Commands` / `MyProfileLinks` / `Directory` | ProfileLink 的写用例、当前用户视角用例和查询用例。 | [../../internal/apiserver/application/identity/profilelink](../../internal/apiserver/application/identity/profilelink) | 当前用户视角会做访问边界检查，不能把它当成全局管理查询。 |
