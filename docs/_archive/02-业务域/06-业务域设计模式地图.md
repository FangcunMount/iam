...
| Strategy | AuthN 多认证方式、Account 创建方式。 | 同一用例下存在多种认证算法和凭据来源。 | [../../internal/apiserver/domain/authn/authentication](../../internal/apiserver/domain/authn/authentication)、[../../internal/apiserver/domain/authn/legacyaccount/interfaces.go](../../internal/apiserver/domain/authn/legacyaccount/interfaces.go) |
...
| Domain Service | 跨实体或依赖外部端口的领域行为。 | 行为不属于单个实体，放应用服务又会丢业务语义。 | [../../internal/apiserver/domain/identity/profilelink](../../internal/apiserver/domain/identity/profilelink)、[../../internal/apiserver/domain/idp/wechatapp](../../internal/apiserver/domain/idp/wechatapp) |
...
| Specification/Validator | Credential、Role、Resource、RoleBinding。 | 校验规则不能散落在 handler 和 repository。 | [../../internal/apiserver/domain/authn/credential/spec.go](../../internal/apiserver/domain/authn/credential/spec.go)、[../../internal/apiserver/domain/authz/resource/validator.go](../../internal/apiserver/domain/authz/resource/validator.go) |
| DTO/Mapper | transport/application/domain 边界。 | wire 字段、应用命令、领域对象各有语义。 | [../../internal/apiserver/application/identity/profile/mapper.go](../../internal/apiserver/application/identity/profile/mapper.go)、[../../internal/apiserver/transport/rest/idp/handler/wechatapp_mapping.go](../../internal/apiserver/transport/rest/idp/handler/wechatapp_mapping.go) |
...
| Read Model | Suggest 和 CacheGovernance。 | 查询/观测形状不同于业务写模型。 | [../../internal/apiserver/application/suggest](../../internal/apiserver/application/suggest)、[../../internal/apiserver/cache/catalog.go](../../internal/apiserver/cache/catalog.go) |
