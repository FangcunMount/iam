...
type Repository interface {
	...
	ListBySubject(ctx context.Context, subjectType SubjectType, subjectID meta.ID, tenantID string) ([]*Binding, error)
	// ListByRole 根据角色列出赋权
	ListByRole(ctx context.Context, roleID meta.ID, tenantID string) ([]*Binding, error)
}
