...
// WithContext attaches ctx to the active transaction when one exists, otherwise
// it attaches ctx to db. Repository implementations can use this helper to stay
// transaction-aware without knowing how the transaction is stored.
