...
database_status() {
  ...
  local database_size table_count schema_objects cleanup_backup_rows cleanup_backup_metadata cleanup_backup_fk_dependencies cleanup_backup_trigger_dependencies cleanup_backup_view_dependencies cleanup_backup_routine_dependencies cleanup_backup_event_dependencies cleanup_backup_dependencies backup_count latest_backup migration_state retired_table_state migration_lock_state
